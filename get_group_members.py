...
AD_SERVER = 'YourDomainControllerServer'
AD_BASEDN = 'YourDomainBaseDN'
AD_GROUP_BASEDN = 'YourDomainGroupDN'
AD_BIND_USER = 'YourDomainUser'
AD_BIND_PWD = 'UserPassword'
...
def get_users_sAMAccountName(ad_conn, basedn, userList):
    user_tmp = []
    users_sAMAN = []
